...
class RoundController():
    ...
    def create_round(self, tournament):
        ...
        if count == 1:
            ...
            players_data_file = 'data/tournaments/' + tournament.get("id du tournoi") + '_players.json'
            players_data = []
            with open(players_data_file, 'r') as f:
                players_data = json.load(f)

            # Tri des joueurs en ordre décroissant de score
            sorted_players = sorted(players_data, key=lambda player: player['classement'])
        ...
        for number,match in enumerate(round_data):
            ...
            if match['id_round'] == id_selected and int(id_selected) <= len(round_data):
                ...
                for player in players_data:
                    ...
                    elif player["identifiant_national"] ==  match['match']['player2']["identifiant_national"]:
                ...
                TournamentController.tournament_rank_players_update(self,tournament, match)
                break
        ...
        if all_played == True:   
            ...
            for number,tournamentwrite in enumerate(tournaments):
                ...
                if tournamentwrite["id du tournoi"] == prefixed_tournament:
                    ...
                    tournamentwrite["numero_round_actif"] = tournament["numero_round_actif"]
