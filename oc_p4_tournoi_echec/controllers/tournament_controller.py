...
class TournamentController:
    ...
    def create_tournament(self):
        ...
        new_tournament = {
            ...
            "liste_des_joueurs": TournamentController.create_file_player_path(
                tournament_id
            ),
        }
    ...
    def list_tournament_choice(self):
        ...
        selected_tournament = tournament_data_date[
            TournamentView.display_choice_tournament(self)
        ]
    ...
    def add_player_to_tournament(self, tournament: Tournament):
        ...
        if not national_id_new:
            return None
        player_new = PlayerController.search_player(
            self, search_criteria=national_id_new
        )
        ...
        if player_new is not None:
            ...
            PlayerController.update_file_players(
                self, players=tournament_players, file_path=fpath
            )
